...
export default class UI_ShopScrollView extends cc.ScrollView {
    ...
    onLoad() {
        ...
        Global.Inst.On(LocMsg.UPDATE_SHOP_DATA, this._FreashShopData, this);
    }
    private _FreashShopData(gameTypeCreatDatas: IRobot[]) {
    ...
    protected onEnable(): void {
        ...
        let robotList = DataManager.Inst.GetData<IRobot[]>(DataBaseKey.SHOP_DATA);
